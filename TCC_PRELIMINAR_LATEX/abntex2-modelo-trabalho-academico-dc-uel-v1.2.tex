...
% Estudante, este documento foi feito para ajudar seu processo de elaboração
% e formatação do texto, então observe os campos a serem preenchidos, 
% substitua pelas suas informações e informações do seu trabalho,
% e depois exclua os trechos que não serão utilizados.
...
\documentclass[
    ...
    % --------------- Atenção estudante:  
	tcc,			% escreva aqui seu tipo do trabalho, dentre as seguintes opções:
                    % tcc, tccpreliminar, dissertacao OU qualificacaoms          
                    % essas opções preenchem de forma automática as informações do preâmbulo:
					% - tcc (Versão para a Banca do TCC ou Versão Final do TCC)
					% - tccpreliminar (Versão Preliminar do TCC)
					% - dissertação (Versão para a Banca da Dissertação, Versão Final ou Revisada)
...
\data{2026} % ao alterar o ano aqui, ele altera no restante do texto.
...
% Só deve ser mantido o 4º membro da Banca para trabalhos de
% Dissertação, em tcc deve ser removido/comentado.
...
Agradecimentos também aos professores Dr. Daniel Kaster e Dr. Wesley Attrot pelas contribuições neste modelo que atende os cursos de Ciência da Computação e Ciência de Dados e Inteligência Artificial, do Departamento de Computação da Universidade Estadual de Londrina.
